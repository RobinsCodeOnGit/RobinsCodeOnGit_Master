...
namespace GameOfLife_2
{
    class LifeCellGrid
    {
        ...
        private List<int> StatisticAnalyses;
        ...
        public LifeCellGrid()
        {
            ...
            this.StatisticAnalyses = new List<int>();
        ...
        public int GetCountOfLivingCells()
        {
            int x = 0;
            for (int i = 0; i < OldCellGrid.GetLength(0) -1; i++)
            {
                for (int j = 0; j < OldCellGrid.GetLength(1) -1; j++)
                {
                    x += (OldCellGrid[i, j].CellState) ? 1 : 0;
                }
            }
            StatisticAnalyses.Add(x);
            return x;
        }
        public List<int> GetStatisticAnalysesList()
        {
